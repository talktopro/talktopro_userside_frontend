...
const MentorHeader = () => {
  ...
  return (
    <header className="flex h-16 sticky top-0 bg-background z-1 shrink-0 justify-between items-center gap-2 transition-[width,height] ease-linear group-has-[[data-collapsible=icon]]/sidebar-wrapper:h-16">
